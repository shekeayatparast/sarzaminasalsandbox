...
export const PRODUCTS_SEED: ProductSeed[] = [
  {
    ...
    slug: "gon",
    description:
      "عسل گون از شهد گل‌های گیاه گون (یونجه شتر) تولید می‌شود. این عسل رنگی روشن و طلایی، طعمی ملایم و شیرین و عطر لطیف گل‌های بهاری دارد. یکی از محبوب‌ترین عسل‌های ایران برای مصرف روزانه.",
    pricePerKg: 1400000,
    color: "طلایی روشن",
  ...
  },
  {
    ...
    slug: "konar",
    description:
      "عسل کنار (سدر) از شهد درختان کنار (سدر) به دست می‌آید. رنگی تیره و کهربایی، طعمی غنی و خوش‌طعم با کمی تلخی ملایم دارد. از باارزش‌ترین و گران‌قیمت‌ترین عسل‌های جهان به شمار می‌رود.",
    pricePerKg: 1200000,
    color: "کهربایی تیره",
  ...
  },
  {
    ...
    slug: "multi-plant",
    description:
      "عسل چند گیاه (چندگل) از شهد انواع گل‌ها و گیاهان دارویی مختلف جمع‌آوری می‌شود. طعمی متعادل و رنگی کهربایی دارد و ترکیبی از خواص متنوع گیاهان مختلف را در خود جای داده است.",
    pricePerKg: 1200000,
    color: "کهربایی متوسط",
